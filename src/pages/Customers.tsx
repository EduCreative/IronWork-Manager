        ...
        <div className="p-4 border-b border-gray-100 dark:border-gray-800">
          <div className="relative max-w-sm">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-theme-bg border border-theme-border text-theme-text rounded-xl text-sm focus:ring-2 focus:ring-blue-500 placeholder:text-gray-400 focus:outline-none"
              value={searchTerm}
